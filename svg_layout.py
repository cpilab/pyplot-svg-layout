...
class Panel:
    ...
    def __init__(self, path: str, x: float, y: float, w: float, h: float,
                 plotting_function: Optional[Callable[[plt.Axes], None]] = None, keep_aspect_ratio: bool = False):
        """
        ...
        # self.keep_aspect_ratio = regenerate_svg is None   # always keep aspect ratio if the svg is pre-generated
